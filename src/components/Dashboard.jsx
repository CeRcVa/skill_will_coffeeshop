...
function Dashboard() {
  ...
  return (
    <div className="dashboard-container">
      ...
      <button className="dashboard-button" onClick={handleAdd}>Add New Coffee</button>
      ...
      {coffees.length === 0 ? (
        ...
        <>
          ...
          <h2 className="dashboard-title">Coffee Cards</h2>
          <div className="dashboard-card-container">
            {coffees.map(coffee => (
              <div className="dashboard-card" key={coffee.id}>
                <h3>{coffee.name}</h3>
